...
const Layout = ({ alive, accounts }) => (
  <div>
    ...
    {/* Only use this section if you need to add a banner to the web for giving
        related incidents only. Otherwise, please leave this commented out. */}
    <div
      className="soft-double-sides@lap-and-up soft-ends@anchored soft background--light-primary"
      style={{ overflow: "visible" }}
    >
      <div
        className="card soft-top soft-sides"
        style={{ backgroundColor: "#6BAC43", color: "#FFFFFF" }}
      >
        <h4>You&#39;re Giving Is Working</h4>
        <p>
          We are experiencing some glitches with receipts being sent out via email, but rest
          assured, you&#39;re gifts are being received and processed correctly. Thank you for being
          patient with us while we straighten out the situation with our transaction receipts.
        </p>
      </div>
    </div>
                    ...
                    return (
                      <Link className="plain" to={`/give/campaign/${encodeURI(account.name)}`}>
                        ...
                        <div className="display-inline-block" style={{ verticalAlign: "middle" }}>
                          ...
                          />
                          <h7 className="text-dark-tertiary" style={{ verticalAlign: "middle" }}>
                            Contribution Fund
                          </h7>
